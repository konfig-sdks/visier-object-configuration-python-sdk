...
NAME = "visier-object-configuration-python-sdk"
...
setup(
    ...
    url="https://github.com/konfig-sdks/visier-object-configuration-python-sdk/tree/main/python",
    keywords=["Konfig", "Visier Object Configuration APIs"],
    python_requires=">=3.7",
