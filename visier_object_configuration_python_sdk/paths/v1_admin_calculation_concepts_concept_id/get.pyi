...
from visier_object_configuration_python_sdk.model.calculation_concept_dto import CalculationConceptDTO as CalculationConceptDTOSchema
...
from visier_object_configuration_python_sdk.pydantic.calculation_concept_dto import CalculationConceptDTO as CalculationConceptDTOPydantic
...
SchemaFor200ResponseBodyApplicationJson = CalculationConceptDTOSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CalculationConceptDTO
...
class BaseApi(api_client.Api):
    ...
    def _get_calculation_concept_mapped_args(
        self,
        concept_id: str,
    ...
    async def _aget_calculation_concept_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/admin/calculation-concepts/{conceptId}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_calculation_concept_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetCalculationConceptRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_calculation_concept(
        self,
        concept_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_calculation_concept_mapped_args(
            concept_id=concept_id,
        )
        return await self._aget_calculation_concept_oapg(
    ...
    def get_calculation_concept(
        ...
        return self._get_calculation_concept_oapg(
            path_params=args.path,
        )

class GetCalculationConcept(BaseApi):
    ...
    async def aget_calculation_concept(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CalculationConceptDTOPydantic:
        raw_response = await self.raw.aget_calculation_concept(
            concept_id=concept_id,
            **kwargs,
        )
        if validate:
            return CalculationConceptDTOPydantic(**raw_response.body)
        return api_client.construct_model_instance(CalculationConceptDTOPydantic, raw_response.body)
    ...
    def get_calculation_concept(
        ...
        raw_response = self.raw.get_calculation_concept(
            concept_id=concept_id,
        )
        if validate:
            return CalculationConceptDTOPydantic(**raw_response.body)
