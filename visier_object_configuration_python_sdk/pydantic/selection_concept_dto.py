...
from visier_object_configuration_python_sdk.pydantic.selection_concept_configuration_dto import SelectionConceptConfigurationDTO
...
class SelectionConceptDTO(BaseModel):
    ...
    configuration: typing.Optional[SelectionConceptConfigurationDTO] = Field(None, alias='configuration')
    class Config:
